...
<%
	...
	try{
		...
		psmt.setString(2,request.getParameter("userId"));
		psmt.setString(3,request.getParameter("userPwd"));
		psmt.setString(4,request.getParameter("userEmail"));
		psmt.setString(5,request.getParameter("phone"));
		psmt.setInt(6,Integer.parseInt(request.getParameter("admin")));
